...
const motivationalQuotes = [
  {
    quote:
      "Ubuntu: I am because we are. Your success contributes to our collective growth.",
  ...
  {
    quote:
      "Your career is a marathon, not a sprint. Pace yourself and stay consistent.",
...
const OnboardingPage = () => {
  ...
  const steps = [
    {
      ...
      guidance:
        "This information helps employers understand who you are and how to contact you. A complete profile increases your visibility by 40%.",
      required: true,
    },
    {
      id: "experience",
      ...
      guidance:
        "Showcase your career progression and achievements. Use action verbs and quantify your impact where possible.",
      required: false,
    },
    {
      id: "education",
      ...
      guidance:
        "Include your formal education and any relevant certifications. This helps establish your knowledge foundation.",
      required: false,
    },
    {
      id: "skills",
      ...
      guidance:
        "List both technical and soft skills. Be honest about your proficiency levels - employers value authenticity.",
      required: false,
    },
  ];
  ...
  useEffect(() => {
    ...
    setCanExit(mandatoryFieldsComplete as any);
  }, [formData.personalInfo.fullName, formData.personalInfo.email]);
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600">
            Add a professional headshot (max 5MB)
          </p>
          {uploadingImage && (
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-500">
            Optional - helps employers contact you
          </p>
        </div>
        <div className="space-y-2">
          <label className="block text-sm font-semibold text-slate-700">
          ...
          <p className="text-xs text-slate-500">
            Optional - helps with location-based job matching
          </p>
        </div>
      </div>
      <div className="space-y-2">
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm text-slate-500">
            <p>
              This will help employers understand your career goals and
              experience.
            </p>
      ...
      {formData.experiences.map((exp, index) => (
        ...
        >
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-slate-500">
              Use bullet points and action verbs. Quantify your achievements
              where possible.
            </p>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <select
                value={skill.level}
                onChange={(e) =>
                  handleInputChange("skills", "level", e.target.value, index)
                }
                className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
              >
              ...
              return (
                ...
                >
                  ...
                  {index < steps.length - 1 && (
                    <div
                      className={`w-full h-1 mx-4 transition-all duration-500 ${
