...
const InterviewPracticePage = () => {
  ...
  const [currentStep, setCurrentStep] = useState<
    "setup" | "credits-check" | "interview" | "analysis" | "final"
  >("setup");
  ...
  const [hasEnoughCreditsState, setHasEnoughCreditsState] =
  ...
  const sessionTypes = [
    ...
    {
      id: "introduction",
      label: "Introduction Practice",
      description: "Practice self-introduction",
    },
    {
      id: "experience",
      label: "Experience Questions",
      description: "Behavioral and experience-based",
    },
    {
    ...
    const checkUserCredits = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setHasEnoughCreditsState(
            hasEnoughCredits(balance, CREDIT_COSTS.INTERVIEW_SESSION)
          );
        }
      } catch (error) {
        ...
        setCreditsBalance(0);
        setHasEnoughCreditsState(false);
      }
    };
  ...
  const checkCreditsBeforeStart = async () => {
    ...
    try {
      ...
      const data = await response.json();
      setHasEnoughCreditsState(data.hasCredits);

      if (!data.hasCredits) {
        setCreditsError(
          `You need ${data.creditsNeeded} credits to start this interview session. You currently have ${creditsBalance} credits.`
        );
        return false;
      }
      ...
      console.error("Error checking credits:", error);
      setCreditsError(
        error instanceof Error ? error.message : "Failed to verify credits"
      );
      return false;
    } finally {
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSessionConfig((prev) => ({ ...prev, role: e.target.value }))
              }
            ...
            {selectedSavedJob && (
              <p className="text-xs text-slate-500 mt-1">
                Role automatically filled from saved job
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 text-center">
                ...
                <div className="text-sm text-slate-600">
                  questions ({sessionConfig.questionCount * 2}-
                  {sessionConfig.questionCount * 3} minutes)
                </div>
              </div>
            ...
            <div className="mt-3 bg-slate-50 rounded-lg p-3">
              <p className="text-sm text-slate-600 text-center">
                Choose between 2-5 questions. More questions = longer practice
                session.
              </p>
            </div>
          </div>
          ...
          <div className="border border-slate-200 rounded-xl p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-slate-900">
                  {sessionConfig.experienceYears} years
                </span>
              </div>
              <div className="flex justify-between">
                ...
                <span className="font-medium text-slate-900">
                  {
                    sessionTypes.find((t) => t.id === sessionConfig.sessionType)
                      ?.label
                  }
                </span>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-900">
                    {
                      sessionTypes.find(
                        (t) => t.id === sessionConfig.sessionType
                      )?.label
                    }
                  </p>
                </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {Object.entries(finalAnalysis.categoryScores || {}).map(
                ([category, score]) => (
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <ul className="space-y-2">
                {finalAnalysis.strengths?.map(
                  (strength: string, index: number) => (
                    <li
                      key={index}
                      className="text-green-800 flex items-start space-x-2"
                    >
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
              ...
              <ul className="space-y-2">
                {finalAnalysis.areasForImprovement?.map(
                  (improvement: string, index: number) => (
                    <li
                      key={index}
                      className="text-orange-800 flex items-start space-x-2"
                    >
            ...
            <ul className="space-y-2">
              {finalAnalysis.recommendations?.map(
                (recommendation: string, index: number) => (
                  <li
                    key={index}
                    className="text-blue-800 flex items-start space-x-2"
                  >
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-4">
            You need to be signed in to practice interviews.
          </p>
          <Link href="/auth">
